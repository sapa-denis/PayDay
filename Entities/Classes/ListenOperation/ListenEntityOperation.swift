...
final public class ListenEntityOperation<Entity: NSManagedObject>:
CoreOperation<Void, CollectionChange<Entity>>, NSFetchedResultsControllerDelegate {
    ...
    public func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>,
        ...
        guard let object = anObject as? Entity else {
            fatalError(.castingFatalMessage)
        }

        collectionChange.changeType = .update(object: object,
