...
public typealias CustomerInfo = Networking.CustomerInfo
...
public final class RegistrationUseCase: UseCase<Int> {
    ...
    // MARK: - Public methods
    public func prepare(with customerInfo: CustomerInfo) -> Self {
        let request = PayDayRequest.registrate(info: customerInfo)
