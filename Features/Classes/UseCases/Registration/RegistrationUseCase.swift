...
public final class RegistrationUseCase: UseCase<Int> {
    ...
    // MARK: - Public methods
    public func prepare(with firstName: String,
                        lastName: String,
                        email: String,
                        phone: String,
                        password: String,
                        gender: String,
                        dateOfBirth: String) -> Self {
        
        let info = PayDayRequest.CustomerInfo(firstName: firstName,
                                              lastName: lastName,
                                              gender: gender,
                                              email: email,
                                              password: password,
        ...
        let request = PayDayRequest.registrate(info: info)
